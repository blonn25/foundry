...
def design(ctx: typer.Context):
    ...
    # Development: models/rfd3_system/src/rfd3_system/cli.py -> models/rfd3_system/configs/
    # Installed: site-packages/rfd3_system/cli.py -> site-packages/rfd3_system/configs/
    ...
    with initialize_config_dir(config_dir=config_path, version_base="1.3"):
        ...
        from rfd3_system.run_inference import run_inference
