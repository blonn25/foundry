...
from rfd3_system.model.cfg_utils import (
    strip_f,
)
from rfd3_system.model.inference_sampler import ConditionalDiffusionSampler
from rfd3_system.model.layers.encoders import TokenInitializer
...
class RFD3(nn.Module):
    ...
    def forward_coupled(
        ...
        *,
        ...
        ordinary RFD3, but delegates rollout to the `superdiff_shared_chain`
        sampler registered in `ConditionalDiffusionSampler`.
        """
        ...
        if self.use_classifier_free_guidance:
            raise ValueError(
                "Approximate shared-chain coupling does not currently support "
        ...
        return self.inference_sampler.sample_coupled_superdiff_proxy(
            track_1={
                "f": track_1_input["f"],
