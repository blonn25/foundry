"""Commented BindCraft ColabDesign utilities.

Adapted from BindCraft ``functions/colabdesign_utils.py`` at commit
``b971db42ba6e091afab63ccb30ae02215150a990``.

DROPPED: this entire module is BindCraft-design-pipeline-specific and requires
the full ColabDesign/JAX/AF2 stack. The original source is preserved below as
comments for reference, but no functions are active in rfd3_system.
"""
