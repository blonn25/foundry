...
from rfd3_system_v3.transforms.conditioning_utils import sample_island_tokens
...
def ensure_inference_sampler_matches_design_spec(
    ...
    if any(has_symmetry_specification):
        raise ValueError(
            "rfd3_system_v3 reverse-SDE samplers do not support symmetry. "
            "Use the original rfd3 symmetry sampler for symmetric generation."
        )
