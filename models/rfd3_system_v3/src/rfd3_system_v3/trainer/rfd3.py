...
from rfd3_system_v3.metrics.design_metrics import get_all_backbone_metrics
from rfd3_system_v3.metrics.hbonds_hbplus_metrics import get_hbond_metrics
from rfd3_system_v3.trainer.recycling import get_recycle_schedule
from rfd3_system_v3.trainer.trainer_utils import (
        ...
        for i, atom_array in enumerate(arrays):
            ...
            if "partial_t" in f:
                ...
                if xyz_ca_input.shape == xyz_ca_output.shape:
                    try:
                        from rfd3_system_v3.utils.alignment import weighted_rigid_align
