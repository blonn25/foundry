...
def design(ctx: typer.Context):
    ...
    # Development: models/rfd3_system_v3/src/rfd3_system_v3/cli.py -> models/rfd3_system_v3/configs/
    # Installed: site-packages/rfd3_system_v3/cli.py -> site-packages/rfd3_system_v3/configs/
    ...
    with initialize_config_dir(config_dir=config_path, version_base="1.3"):
        ...
        from rfd3_system_v3.run_inference import run_inference
