...
def design(ctx: typer.Context):
    ...
    # Find the prototype configs directory relative to this file.
    # Development: models/rfd3_system_v2/src/rfd3_system_v2/cli.py -> models/rfd3_system_v2/configs/
    # Installed: site-packages/rfd3_system_v2/cli.py -> site-packages/rfd3_system_v2/configs/
    ...
    with initialize_config_dir(config_dir=config_path, version_base="1.3"):
        ...
        from rfd3_system_v2.run_inference import run_inference
