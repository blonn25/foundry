...
from rfd3_system.metrics.design_metrics import get_all_backbone_metrics
from rfd3_system.metrics.hbonds_hbplus_metrics import get_hbond_metrics
from rfd3_system.trainer.recycling import get_recycle_schedule
from rfd3_system.trainer.trainer_utils import (
        ...
        for i, atom_array in enumerate(arrays):
            ...
            if "partial_t" in f:
                ...
                if xyz_ca_input.shape == xyz_ca_output.shape:
                    try:
                        from rfd3_system.utils.alignment import weighted_rigid_align
